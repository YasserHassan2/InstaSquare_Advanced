...
public class BackgroundAdapter extends RecyclerView.Adapter<BackgroundAdapter.ViewHolder> {
    ...
    public BackgroundAdapter(Context context2, BackgroundAdapter.BackgroundListener backgroundChangeListener2, List<Drawable> list) {
        this.context = context2;
        this.backgroundListener = backgroundChangeListener2;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            BackgroundAdapter.this.backgroundListener.onBackgroundSelected((SquareView) BackgroundAdapter.this.squareViewList.get(BackgroundAdapter.this.selectedIndex));
