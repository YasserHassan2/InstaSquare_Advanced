...
public class BackgroundGridAdapter extends RecyclerView.Adapter<BackgroundGridAdapter.ViewHolder> {
    ...
    public BackgroundGridAdapter(Context context2, BackgroundGridListener backgroundChangeListener2, boolean z) {
        ...
        this.squareViewList.add(new SquareView(R.drawable.gradient_65, "Gradient_65"));
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_square_grid, viewGroup, false));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            BackgroundGridAdapter.this.selectedIndex = getAdapterPosition();
            BackgroundGridAdapter.this.backgroundListener.onBackgroundSelected((SquareView) BackgroundGridAdapter.this.squareViewList.get(BackgroundGridAdapter.this.selectedIndex));
            BackgroundGridAdapter.this.notifyDataSetChanged();
        }
    }
