        ...
        ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    DivideAdapter.this.divideListener.onFilterSelected(((EffectCodeAsset.EffectsCode) DivideAdapter.this.effectsCodeList.get(DivideAdapter.this.selectIndex)).getImage());
