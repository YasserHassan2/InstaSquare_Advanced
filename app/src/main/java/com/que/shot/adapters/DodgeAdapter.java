        ...
        ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    DodgeAdapter.this.selectIndex = ViewHolder.this.getLayoutPosition();
                    DodgeAdapter.this.dodgeListener.onFilterSelected(((EffectCodeAsset.EffectsCode) DodgeAdapter.this.effectsCodeList.get(DodgeAdapter.this.selectIndex)).getImage());
                    DodgeAdapter.this.notifyDataSetChanged();
                }
            });
        }
    }
