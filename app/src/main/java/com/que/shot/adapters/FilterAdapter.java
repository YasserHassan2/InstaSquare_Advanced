        ...
        ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    FilterAdapter.this.filterListener.onFilterSelected(((FilterCodeAsset.FiltersCode) FilterAdapter.this.filterBeanList.get(FilterAdapter.this.selectedIndex)).getCode());
