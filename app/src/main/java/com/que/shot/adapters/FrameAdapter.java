...
public class FrameAdapter extends RecyclerView.Adapter<FrameAdapter.ViewHolder> {
    ...
    public FrameAdapter(Context context, FrameListener frameListener) {
        ...
        this.squareViewList.add(new SquareView(R.drawable.gradient_0, "None"));
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            FrameAdapter.this.frameListener.onBackgroundSelected((SquareView) FrameAdapter.this.squareViewList.get(FrameAdapter.this.selectedSquareIndex));
