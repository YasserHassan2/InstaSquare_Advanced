...
public class QueShotDrawToolsAdapter extends RecyclerView.Adapter<QueShotDrawToolsAdapter.ViewHolder> {
    ...
    public QueShotDrawToolsAdapter(OnQuShotDrawItemSelected onItemSelected) {
        ...
        this.toolModelArrayList.add(new ModuleModel("Paint", R.drawable.ic_neon, Module.PAINT));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.relative_layout_wrapper_tool.setOnClickListener(view1 ->
                    QueShotDrawToolsAdapter.this.onQuShotDrawItemSelected.onQuShotDrawToolSelected((QueShotDrawToolsAdapter.this.toolModelArrayList.get(ViewHolder.this.getLayoutPosition())).toolType));
        }
    }
}
