...
public class QueShotStickersToolsAdapter extends RecyclerView.Adapter<QueShotStickersToolsAdapter.ViewHolder> {
    ...
    public QueShotStickersToolsAdapter(OnQuShotStickerItemSelected onItemSelected) {
        ...
        this.toolModelArrayList.add(new ModuleModel("Clothes", R.drawable.ic_women, Module.BEAUTY));
        this.toolModelArrayList.add(new ModuleModel("Emoji", R.drawable.ic_emoji, Module.STICKER));
        this.toolModelArrayList.add(new ModuleModel("Style", R.drawable.ic_men, Module.MACKUER));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.relative_layout_wrapper_tool.setOnClickListener(view1 ->
                    QueShotStickersToolsAdapter.this.onQuShotDrawItemSelected.onQuShotStickerToolSelected((QueShotStickersToolsAdapter.this.toolModelArrayList.get(ViewHolder.this.getLayoutPosition())).toolType));
        }
    }
}
