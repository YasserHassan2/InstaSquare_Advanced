...
public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        Bitmap bitmap = StickersAsset.loadBitmapFromAssets(this.context, this.stringList.get(i));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            StickerAdapter.this.onClickSplashListener.addSticker(StickersAsset.loadBitmapFromAssets(StickerAdapter.this.context, (String) StickerAdapter.this.stringList.get(getAdapterPosition())));
        }
    }
}
