...
public class DivideFragment extends DialogFragment implements DivideListener {
    private static final String TAG = "DivideFragment";
    ...
    public static DivideFragment show(@NonNull AppCompatActivity appCompatActivity, OnFilterSavePhoto onFilterSavePhoto2, Bitmap bitmap2, List<Bitmap> list) {
        DivideFragment filterDialogFragment = new DivideFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.recycler_view_filter.setAdapter(new DivideAdapter(this.lstFilterBitmap, this, getContext(), Arrays.asList(EffectCodeAsset.DIVIDE_EFFECTS)));
        ...
        this.textViewTitle.setText("DIVIDE");
        (inflate.findViewById(R.id.imageViewSaveFilter)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DivideFragment.this.onFilterSavePhoto.onSaveFilter(((BitmapDrawable) DivideFragment.this.image_view_preview.getDrawable()).getBitmap());
                DivideFragment.this.dismiss();
            }
        });
    ...
    class LoadBitmapWithFilter extends AsyncTask<String, Bitmap, Bitmap> {
        ...
        public Bitmap doInBackground(String... strArr) {
            return FilterUtils.getBitmapWithFilter(DivideFragment.this.bitmap, strArr[0]);
        }

        public void onPostExecute(Bitmap bitmap) {
            DivideFragment.this.image_view_preview.setImageBitmap(bitmap);
        }
    }
