...
public class DodgeFragment extends DialogFragment implements DodgeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.recycler_view_filter.setAdapter(new DodgeAdapter(this.lstFilterBitmap, this, getContext(), Arrays.asList(EffectCodeAsset.DODGE_EFFECTS)));
        ...
        (inflate.findViewById(R.id.imageViewSaveFilter)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DodgeFragment.this.onFilterSavePhoto.onSaveFilter(((BitmapDrawable) DodgeFragment.this.image_view_preview.getDrawable()).getBitmap());
                DodgeFragment.this.dismiss();
            }
        });
    ...
    class LoadBitmapWithFilter extends AsyncTask<String, Bitmap, Bitmap> {
        ...
        public Bitmap doInBackground(String... strArr) {
            return FilterUtils.getBitmapWithFilter(DodgeFragment.this.bitmap, strArr[0]);
        }

        public void onPostExecute(Bitmap bitmap) {
            DodgeFragment.this.image_view_preview.setImageBitmap(bitmap);
        }
    }
