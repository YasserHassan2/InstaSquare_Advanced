...
public interface QueShotLayout {
    QueShotLayout clone(QueShotLayout quShotLayout);

    Info generateInfo();

    QueShotArea getArea(int i);
    ...
    QueShotArea getOuterArea();

    List<QueShotLine> getOuterLines();
    ...
    class Info implements Parcelable {
        ...
        public ArrayList<QueShotLine> lines;
    ...
    class Step implements Parcelable {
        ...
        public QueShotLine.Direction lineDirection() {
            return this.direction == 0 ? QueShotLine.Direction.HORIZONTAL : QueShotLine.Direction.VERTICAL;
        }
    ...
    class LineInfo implements Parcelable {
        ...
        public LineInfo(QueShotLine line) {
