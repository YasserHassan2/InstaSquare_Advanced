...
class SlantArea implements QueShotArea {
    ...
    public Path getAreaPath() {
        this.areaPath.reset();
        if (this.radian > 0.0f) {
            SlantUtils.getPoint(this.tempPoint, this.leftTop, this.leftBottom, QueShotLine.Direction.VERTICAL, this.radian / SlantUtils.distance(this.leftTop, this.leftBottom));
            ...
            SlantUtils.getPoint(this.tempPoint, this.leftTop, this.rightTop, QueShotLine.Direction.HORIZONTAL, distance);
            this.tempPoint.offset(this.paddingLeft, this.paddingTop);
            this.areaPath.quadTo(this.leftTop.x + this.paddingLeft, this.leftTop.y + this.paddingTop, this.tempPoint.x, this.tempPoint.y);
            SlantUtils.getPoint(this.tempPoint, this.leftTop, this.rightTop, QueShotLine.Direction.HORIZONTAL, 1.0f - distance);
            ...
            SlantUtils.getPoint(this.tempPoint, this.rightTop, this.rightBottom, QueShotLine.Direction.VERTICAL, distance2);
            this.tempPoint.offset(-this.paddingRight, this.paddingTop);
            this.areaPath.quadTo(this.rightTop.x - this.paddingLeft, this.rightTop.y + this.paddingTop, this.tempPoint.x, this.tempPoint.y);
            SlantUtils.getPoint(this.tempPoint, this.rightTop, this.rightBottom, QueShotLine.Direction.VERTICAL, 1.0f - distance2);
            ...
            SlantUtils.getPoint(this.tempPoint, this.leftBottom, this.rightBottom, QueShotLine.Direction.HORIZONTAL, distance3);
            this.tempPoint.offset(-this.paddingRight, -this.paddingBottom);
            ...
            SlantUtils.getPoint(this.tempPoint, this.leftBottom, this.rightBottom, QueShotLine.Direction.HORIZONTAL, 1.0f - distance3);
            ...
            SlantUtils.getPoint(this.tempPoint, this.leftTop, this.leftBottom, QueShotLine.Direction.VERTICAL, distance4);
            this.tempPoint.offset(this.paddingLeft, -this.paddingBottom);
            ...
            SlantUtils.getPoint(this.tempPoint, this.leftTop, this.leftBottom, QueShotLine.Direction.VERTICAL, 1.0f - distance4);
            this.tempPoint.offset(this.paddingLeft, this.paddingTop);
            this.areaPath.lineTo(this.tempPoint.x, this.tempPoint.y);
        } else {
    ...
    public boolean contains(QueShotLine line) {
    ...
    public List<QueShotLine> getLines() {
        return Arrays.asList(new QueShotLine[]{this.lineLeft, this.lineTop, this.lineRight, this.lineBottom});
    }

    public PointF[] getHandleBarPoints(QueShotLine line) {
