...
class SlantUtils {
    ...
    static List<SlantArea> cutAreaWith(SlantArea slantArea, SlantLine slantLine) {
        ...
        if (slantLine.direction == QueShotLine.Direction.HORIZONTAL) {
    ...
    static SlantLine createLine(SlantArea slantArea, QueShotLine.Direction direction, float f, float f2) {
        ...
        if (direction == QueShotLine.Direction.HORIZONTAL) {
            slantLine.start = getPoint(slantArea.leftTop, slantArea.leftBottom, QueShotLine.Direction.VERTICAL, f);
            slantLine.end = getPoint(slantArea.rightTop, slantArea.rightBottom, QueShotLine.Direction.VERTICAL, f2);
            ...
            slantLine.start = getPoint(slantArea.leftTop, slantArea.rightTop, QueShotLine.Direction.HORIZONTAL, f);
            slantLine.end = getPoint(slantArea.leftBottom, slantArea.rightBottom, QueShotLine.Direction.HORIZONTAL, f2);
    ...
    static Pair<List<SlantLine>, List<SlantArea>> cutAreaWith(SlantArea slantArea, int i, int i2) {
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            ...
            SlantLine createLine = createLine(slantArea2, QueShotLine.Direction.HORIZONTAL, f - 0.025f, f + 0.025f);
        ...
        while (true) {
            ...
            SlantLine createLine2 = createLine(slantArea3, QueShotLine.Direction.VERTICAL, f2 + 0.025f, f2 - 0.025f);
    ...
    private static CrossoverPointF getPoint(PointF pointF, PointF pointF2, QueShotLine.Direction direction, float f) {
    ...
    static void getPoint(PointF pointF, PointF pointF2, PointF pointF3, QueShotLine.Direction direction, float f) {
    ...
    static boolean contains(SlantLine slantLine, float f, float f2, float f3) {
        ...
        if (slantLine.direction == QueShotLine.Direction.VERTICAL) {
