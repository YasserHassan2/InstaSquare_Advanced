...
public abstract class StraightCollageLayout implements QueShotLayout {
    ...
    public void update() {
        for (QueShotLine update : this.lines) {
    ...
    public QueShotArea getArea(int i) {
    ...
    public void addLine(int i, QueShotLine.Direction direction, float f) {
    ...
    private List<StraightArea> addLine(StraightArea straightArea, QueShotLine.Direction direction, float f) {
    ...
    public void cutAreaEqualPart(int i, int i2, QueShotLine.Direction direction) {
        int i3;
    ...
    public void addCross(int i, float f, float f2) {
        StraightArea straightArea = this.areas.get(i);
        this.areas.remove(straightArea);
        StraightLine createLine = StraightUtils.createLine(straightArea, QueShotLine.Direction.HORIZONTAL, f);
        StraightLine createLine2 = StraightUtils.createLine(straightArea, QueShotLine.Direction.VERTICAL, f2);
        this.lines.add(createLine);
