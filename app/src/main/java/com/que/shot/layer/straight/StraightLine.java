...
class StraightLine implements QueShotLine {
    ...
    public QueShotLine lowerLine() {
        return this.lowerLine;
    }

    public QueShotLine upperLine() {
        return this.upperLine;
    }

    public QueShotLine attachStartLine() {
        return this.attachLineStart;
    }

    public QueShotLine attachEndLine() {
        return this.attachLineEnd;
    }

    public void setLowerLine(QueShotLine line) {
        this.lowerLine = line;
    }

    public void setUpperLine(QueShotLine line) {
        this.upperLine = line;
    }
