...
class StraightUtils {
    ...
    static StraightLine createLine(StraightArea straightArea, QueShotLine.Direction direction, float f) {
    ...
    static List<StraightArea> cutArea(StraightArea straightArea, StraightLine straightLine) {
        ...
        if (straightLine.direction() == QueShotLine.Direction.HORIZONTAL) {
        ...
        } else if (straightLine.direction() == QueShotLine.Direction.VERTICAL) {
    ...
    static Pair<List<StraightLine>, List<StraightArea>> cutArea(StraightArea straightArea, int i, int i2) {
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            StraightLine createLine = createLine(straightArea2, QueShotLine.Direction.HORIZONTAL, ((float) (i4 - 1)) / ((float) i4));
        ...
        while (true) {
            ...
            StraightLine createLine2 = createLine(straightArea3, QueShotLine.Direction.VERTICAL, ((float) (i5 - 1)) / ((float) i5));
