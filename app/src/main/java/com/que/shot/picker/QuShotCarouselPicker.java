...
public class QuShotCarouselPicker extends ViewPager {
    ...
    public QuShotCarouselPicker(Context context2) {
        this(context2, (AttributeSet) null);
        this.context = context2;
    }

    public QuShotCarouselPicker(Context context2, AttributeSet attributeSet) {
