...
public class QueShotMosaicView extends ImageView {
    ...
    public QueShotMosaicView(Context context) {
        super(context);
        init();
    }

    public QueShotMosaicView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public QueShotMosaicView(Context context, AttributeSet attributeSet, int i) {
