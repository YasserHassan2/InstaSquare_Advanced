...
import com.que.shot.activities.PhotoPickerActivity;
import com.que.shot.picker.PermissionsUtils;

import java.util.ArrayList;

public class QueShotPickerView {
    ...
    public static class PhotoPickerBuilder {
        ...
        public void start(@NonNull Context context, @NonNull Fragment fragment) {
            if (PermissionsUtils.checkReadStoragePermission(fragment.getActivity())) {
                fragment.startActivityForResult(getIntent(context), QueShotPickerView.REQUEST_CODE);
            }
        }
        ...
        public void start(@NonNull Activity activity) {
            start(activity, (int) QueShotPickerView.REQUEST_CODE);
        }

        public PhotoPickerBuilder setPhotoCount(int i) {
            this.mPickerOptionsBundle.putInt(QueShotPickerView.EXTRA_MAX_COUNT, i);
            return this;
        }

        public PhotoPickerBuilder setGridColumnCount(int i) {
            this.mPickerOptionsBundle.putInt(QueShotPickerView.EXTRA_GRID_COLUMN, i);
            return this;
        }

        public PhotoPickerBuilder setShowGif(boolean z) {
            this.mPickerOptionsBundle.putBoolean(QueShotPickerView.EXTRA_SHOW_GIF, z);
            return this;
        }

        public PhotoPickerBuilder setShowCamera(boolean z) {
            this.mPickerOptionsBundle.putBoolean(QueShotPickerView.EXTRA_SHOW_CAMERA, z);
            return this;
        }

        public PhotoPickerBuilder setSelected(ArrayList<String> arrayList) {
            this.mPickerOptionsBundle.putStringArrayList(QueShotPickerView.EXTRA_ORIGINAL_PHOTOS, arrayList);
            return this;
        }

        public PhotoPickerBuilder setForwardMain(boolean z) {
            this.mPickerOptionsBundle.putBoolean(QueShotPickerView.MAIN_ACTIVITY, z);
            return this;
        }

        public PhotoPickerBuilder setPreviewEnabled(boolean z) {
            this.mPickerOptionsBundle.putBoolean(QueShotPickerView.EXTRA_PREVIEW_ENABLED, z);
            return this;
        }
    }
}
