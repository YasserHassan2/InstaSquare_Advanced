...
public class MatrixUtils {
    ...
    public static float getMinMatrixScale(QueShotGrid puzzlePiece) {
        if (puzzlePiece == null) {
            return 1.0f;
        }
        sTempMatrix.reset();
    ...
    public static boolean judgeIsImageContainsBorder(QueShotGrid puzzlePiece, float f) {
        sTempMatrix.reset();
    ...
    public static float[] calculateImageIndents(QueShotGrid puzzlePiece) {
        if (puzzlePiece == null) {
    ...
    public static Matrix generateMatrix(QueShotGrid puzzlePiece, float f) {
        return generateMatrix(puzzlePiece.getArea(), puzzlePiece.getDrawable(), f);
    }

    public static Matrix generateMatrix(QueShotArea area, Drawable drawable, float f) {
        return generateCenterCropMatrix(area, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight(), f);
    }

    private static Matrix generateCenterCropMatrix(QueShotArea area, int i, int i2, float f) {
        float f2;
